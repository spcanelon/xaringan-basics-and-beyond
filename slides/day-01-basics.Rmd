...
[`r icon::fontawesome("link")` silvia.rbind.io](https://silvia.rbind.io)
[`r icon::fontawesome("twitter")` @spcanelon](https://twitter.com/spcanelon)
[`r icon::icon_style(icon::fontawesome("github"), scale = 1)` @spcanelon](https://github.com/spcanelon)
...
.pull-left-narrow[.center[
`r icon::icon_style(icon::fontawesome("smile"), scale = 3, color = "#e5bf00")`]]
...
.pull-left-narrow[
.center[`r icon::icon_style(icon::fontawesome("markdown"), scale = 2)`]]
.pull-right-wide[.middle[### you know Markdown
]]
...
.pull-left-narrow[
.center[`r icon::icon_style(icon::fontawesome("html5"), scale = 2)`]]
.pull-right-wide[.middle[### .my-gold[**you want to know about cool HTML5 slides**]
]] 
...
`r icon::icon_style(icon::fontawesome("images"), scale = 3)`
...
.pull-right[
3\. From Template `r icon::fontawesome("angle-double-right")` NHS-R Presentation<br>4. Give your slide deck a name!
...
.left[
+ `r icon::fontawesome("file-code")` the new Rmd file (i.e. `my-slides.Rmd`)

+ `r icon::fontawesome("folder-open")` the `img` folder containing logo files

+ `r icon::fontawesome("folder-open")` the `css` folder containing the custom `nhsr` theme files<br>.small[and an HTML file in charge of [adding the NHS logo to each slide](https://www.garrickadenbuie.com/blog/xaringan-tip-logo-all-slides)]
]
] <!---->
...
`r icon::icon_style(icon::fontawesome("code"), scale = 3, color = "#122140")`<br>
# Let's try it live together

---
## Our first few slides

`r icon::icon_style(icon::fontawesome("star"), color = "#e5bf00")` Slide content starts immediately after the YAML `---`
...
`r icon::icon_style(icon::fontawesome("magic"), scale = 3)`
...
.left-col[.center[
`r icon::icon_style(icon::fontawesome("th-large"), scale = 2)`
### with placement
]]
...
.center-col[
.center[
`r icon::icon_style(icon::fontawesome("image"), scale = 2)`
### pretty pictures
]]
...
.right-col[.center[
`r icon::icon_style(icon::fontawesome("star", style = "solid"), scale = 2)`
### and icons
]]
...
.right[.my-coral[example on next slide `r icon::fontawesome("arrow-circle-right")` ]]
]
...
.right[.my-coral[`background-size` examples in action! `r icon::fontawesome("arrow-circle-right")` ]]
] <!---->
...
Use the [icon `r emo::ji("package")`](https://slides.mitchelloharawild.com/icon/): ` r icon::fontawesome("brain")`,<br>or the [fontawesome `r emo::ji("package")`](https://github.com/rstudio/fontawesome#the-fontawesome-package): ` r icon::fontawesome("brain")`
]

--

.pull-left-narrow[.center[
`r icon::academicons("orcid")`<br>
[Academicons](https://jpswalsh.github.io/academicons/)
]]
.pull-right-wide[
The easiest way to access them is with the icon `r emo::ji("package")`:<br>` r icon::fontawesome("orcid")`
]

--

.pull-left-narrow[.center[
`r icon::ionicons("flask")`<br>
[Ionicons](https://ionicons.com/)
]]
.pull-right-wide[
I haven't had as much luck with these, but you can use the icon `r emo::ji("package")` here as well: ` r icon::ionicons("flask")`
]
...
.left-column[
## Your turn<br>`r icon::fontawesome("edit")`<br>
### .my-pink[10:00 mins]
]
...
`r icon::icon_style(icon::fontawesome("r-project"), scale = 3)`
...
.pull-left[.center[
`r icon::icon_style(icon::fontawesome("table"), scale = 2)`
### tables
]]
...
.pull-right[
.center[
`r icon::icon_style(icon::fontawesome("chart-bar"), scale = 2)`
### plots
]]
...
.right[
[silvia.rbind.io `r icon::fontawesome("link")`](https://silvia.rbind.io)<br/>
[@spcanelon `r icon::fontawesome("twitter")`](https://twitter.com/spcanelon)<br/>
[@spcanelon `r icon::fontawesome("github")`](https://github.com/spcanelon)<br/>
]]
