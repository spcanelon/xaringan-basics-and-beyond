...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://spcanelon.github.io/xaringan-basics-and-beyond/slides/day-01-basics.html",
...
.right[.my-coral[example on next slide `r icon::fa("arrow-circle-right")` ]]
]
...
.right[.my-coral[`background-size` examples in action! `r icon::fa("arrow-circle-right")` ]]
] <!---->
