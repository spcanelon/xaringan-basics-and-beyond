...
Use the [icons `r emo::ji("package")`](https://pkg.mitchelloharawild.com/icons/): ` r icons::fontawesome("brain")`,<br>or the [fontawesome `r emo::ji("package")`](https://github.com/rstudio/fontawesome#the-fontawesome-package): ` r fontawesome::fa("brain")`
]
