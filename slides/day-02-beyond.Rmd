...
```{r, echo=FALSE}
knitr::include_graphics("img/recap-yaml-2.png")
```
...
.pull-right[
The [NHS identity guideline](https://www.england.nhs.uk/nhsidentity/identity-guidelines/colours/) colour hex codes `r emo::ji("paint")`
