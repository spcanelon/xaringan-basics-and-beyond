...
meta() %>%
  meta_general(
    description = "An Introduction to xaringan for Presentations: The Beyond",
    generator = "xaringan and remark.js"
  ) %>% 
  meta_name("github-repo" = "spcanelon/xaringan-basics-and-beyond") %>% 
  meta_social(
    title = "Sharing Your Work with xaringan &#8212; Day 2",
    url = "https://spcanelon.github.io/xaringan-basics-and-beyond/slides/day-02-beyond.html#1",
    image = "https://raw.githubusercontent.com/spcanelon/xaringan-basics-and-beyond/main/slides/day-02-cover-image.png",
    image_alt = "Title slide for the day 2 slides of the Sharing Your Work with xaringan workshop series",
    og_type = "website",
...
.pull-left-narrow[
.center[`r icon::icon_style(icon::fontawesome("grin-stars"), scale = 2)`]]
.pull-right-wide[### you've seen pretty slides in the wild]

--

.pull-left-narrow[
.center[`r icon::icon_style(icon::fontawesome("images"), scale = 2)`]]
...
.left-col[.center[
`r icon::icon_style(icon::fontawesome("th"), scale = 2)`
### slide overview
]]
...
.center-col[
.center[
`r icon::icon_style(icon::fontawesome("share-square"), scale = 2)`
### slide embedding
]]
...
.right-col[.center[
`r icon::icon_style(icon::fontawesome("folder"), scale = 2)`
### slide panels
]]
...
```
.small[.right[See this example in the next slide `r icon::fontawesome("arrow-circle-right")`]]
]
...
`r icon::icon_style(icon::fontawesome("css3"), scale = 3)`
...
Here are examples of `r icon::fontawesome("r-project")` places I've managed to apply what I've learned:
...
.small[**Note**: Unlike with many `r icon::fontawesome("r-project")` functions, `color` cannot be replaced with `colour` in CSS land `r emo::ji("disappointed")`]
]
] <!--end of panel-->
