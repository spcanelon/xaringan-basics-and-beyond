...
> Nothing specific in the xaringan default style sheet -- it's possible `highlightStyle` [in the YAML](https://spcanelon.github.io/xaringan-basics-and-beyond/slides/day-01-basics.html?panelset1=yaml-2&panelset4=remark.js2&panelset5=nhsrtheme2&panelset6=moon-reader2&panelset7=markdown2#14) takes the lead on this `r emo::ji("woman_shrugging")`

```{r, echo=FALSE}
knitr::include_url("https://spcanelon.github.io/xaringan-basics-and-beyond/slides/day-01-basics.html?panelset1=yaml-2&panelset4=remark.js2&panelset5=nhsrtheme2&panelset6=moon-reader2&panelset7=markdown2#14", height = 250)
```
...
## Let's talk colors<i class="fas fa-palette" style = "float: right"></i>

.panelset[
.panel[.panel-name[Light Palettes]
```{r, echo=FALSE}
knitr::include_url("https://coolors.co/palettes/trending")
```
...
```{r, echo=FALSE}
knitr::include_url("https://coolors.co/palettes/trending/dark")
```
[coolors.co/palettes/trending/dark](https://coolors.co/palettes/trending/dark)
] <!--end of panel-->
.panel[.panel-name[More resources]
- Check your color combinations for contrast:<br>https://coolors.co/contrast-checker/112a46-acc8e5)

- Create and save your own color palettes:<br>https://coolors.co/f0b67f-fe5f55-d6d1b1-c7efcf-eef5db

- Quickly look up a hex color code:<br>https://www.color-hex.com/
] <!--end of panel-->
]
