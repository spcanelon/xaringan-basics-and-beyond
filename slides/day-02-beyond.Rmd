...
.pull-left-narrow[
.center[`r icons::icon_style(icons::fontawesome("grin-stars"), scale = 2)`]]
.pull-right-wide[### you've seen pretty slides in the wild]

--

.pull-left-narrow[
.center[`r icons::icon_style(icons::fontawesome("images"), scale = 2)`]]
...
.left-col[.center[
`r icons::icon_style(icons::fontawesome("th"), scale = 2)`
### slide overview
]]
...
.center-col[
.center[
`r icons::icon_style(icons::fontawesome("share-square"), scale = 2)`
### slide embedding
]]
...
.right-col[.center[
`r icons::icon_style(icons::fontawesome("folder"), scale = 2)`
### slide panels
]]
...
```
.small[.right[See this example in the next slide `r icons::fontawesome("arrow-circle-right")`]]
]
...
`r icons::icon_style(icons::fontawesome("css3"), scale = 3)`
...
Here are examples of `r icons::fontawesome("r-project")` places I've managed to apply what I've learned:
...
.small[**Note**: Unlike with many `r icons::fontawesome("r-project")` functions, `color` cannot be replaced with `colour` in CSS land `r emo::ji("disappointed")`]
]
] <!--end of panel-->
